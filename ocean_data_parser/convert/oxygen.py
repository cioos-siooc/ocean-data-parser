...
SCOR WG 142: Quality Control Procedures for Oxygen and
Other Biogeochemical Sensors on Floats and Gliders.
Recommendations on the conversion between oxygen quantities
for Bio-Argo floats and other autonomous sensor platforms.
...
def O2ptoO2s(pO2, T, S, p_atm=1013.25):
    """
...
def O2stoO2p(O2sat, T, S, p_atm=1013.25):
    """
